...
Hooks.on('init', () => {
    // loadTemplates(['modules/mcdmbeastheartsheet/template/section.hbs']);
});
...
<div class="form-group">
    ...
    // html[0].querySelector(".center-pane").prepend(selectList);
    // html[0].querySelector(".center-pane").prepend(htmlElement);
    // html.find(".traits .form-group").first().after(htmlElement);
...
export class MCDMCompanion5eSheet extends ActorSheet5eCharacter{

    get template(){
        console.log("Open Beast Companion Sheet")
        console.log(this.actor.data.data)

        return super.template;
    }
}
export class MCDMCaregiver5eSheet extends ActorSheet5eCharacter {
    ...
    //     return "modules/mcdmbeastheartsheet/template/npc-sheet.html";
    // }
    ...
    //     data['useIcons'] = game.settings.get("mcdmbeastheartsheet", "useIcons");
    //     console.log(data);
    ...
    //         //     if (hasProperty(item, 'data.flags.mcdmbeastheartsheet.showItemSummary') && item.data.flags.mcdmbeastheartsheet.showItemSummary) {
    ...
    //         if (hasProperty(item, 'data.flags.mcdmbeastheartsheet.showItemSummary')) {
    //             showItemSummary = !item.data.flags.mcdmbeastheartsheet.showItemSummary;
    //         }
    //         this.supressRender = true;
    //         await item.setFlag('mcdmbeastheartsheet', 'showItemSummary', showItemSummary);
    ...
    //             if (!hasProperty(i, 'flags.mcdmbeastheartsheet')) {
    //                 i.flags.mcdmbeastheartsheet = {};
    //             }
    //             if (!hasProperty(i, 'flags.mcdmbeastheartsheet.showItemSummary')) {
    //                 i.flags.mcdmbeastheartsheet.showItemSummary = game.settings.get("mcdmbeastheartsheet", "expandSpells");
    //             }
    ...
    //     let expandItem = game.settings.get("mcdmbeastheartsheet", "expandFeats");
    //     for (let i of features) {
    //         if (!hasProperty(i, 'flags.mcdmbeastheartsheet')) {
    //             i.flags.mcdmbeastheartsheet = {};
    //         }
    //         if (!hasProperty(i, 'flags.mcdmbeastheartsheet.showItemSummary')) {
    //             i.flags.mcdmbeastheartsheet.showItemSummary = expandItem;
    //         }
    //     }
    //     expandItem = game.settings.get("mcdmbeastheartsheet", "expandAttacks");
    ...
    //     expandItem = game.settings.get("mcdmbeastheartsheet", "expandReactions");
    ...
    //     expandItem = game.settings.get("mcdmbeastheartsheet", "expandLegendary");
    ...
    //     expandItem = game.settings.get("mcdmbeastheartsheet", "expandLair");
    //     for (let i of lair) {
    //         if (!hasProperty(i, 'flags.mcdmbeastheartsheet')) {
    //             i.flags.mcdmbeastheartsheet = {};
    //         }
    ...
    //     expandItem = game.settings.get("mcdmbeastheartsheet", "expandLoot");
    //     for (let i of loot) {
    //         if (!hasProperty(i, 'flags.mcdmbeastheartsheet')) {
    //             i.flags.mcdmbeastheartsheet = {};
    //         }
    ...
    //     // Assign the items
    //     let useIcons = game.settings.get("mcdmbeastheartsheet", "useIcons");
    //     let sections = [
